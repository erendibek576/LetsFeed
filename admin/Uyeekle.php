...
if (isset($_POST["kaydet"])) {
    $sql= "INSERT INTO kullanici_verileri(Ad, Soyad, k_adi, sifre, eposta,kurtarma) VALUES (?, ?, ?, ?, ?,?)";
    ...
    header("Location:Kullanicisayi.php");
}
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <h1 class="display-1 text-center">Kullanıcı Ekle</h1>
                </div>
            </div>
            <div class="row">
                <div class="col">
                    <div class="btn-group">
                        <a href="Kullanicisayi.php" class="btn btn-outline-primary">Tüm Kullanıcılar</a>
    ...
    <main>
       ...
       <form action="" method="post" class="row mt-4 g-3">
            ...
            <div class="col-6">
                <label for="sinif" class="form-label">Kullanıcı Adı</label>
                <input type="text" class="form-control" name="k_adi" required>
            </div>
            <div class="col-6">
                <label for="dtarih" class="form-label">Şifre</label>
                <input type="text" class="form-control" name="sifre" required>
            </div>
             <div class="col-6">
                <label for="dtarih" class="form-label">E-posta</label>
                <input type="text" class="form-control" name="eposta" required>
            </div>
			 <div class="col-6">
                <label for="sad" class="form-label">Şifre unutulursa girilecek anahtar kelime</label>
                <input type="text" class="form-control" name="kurtarma" required>
            </div>
