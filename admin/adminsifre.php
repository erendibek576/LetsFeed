...
if (isset($_POST["kaydet"])) {
    $sql= "UPDATE admin SET sifre=? WHERE admin=?";
...
<body>
    ...
    <header>
        <div class="container">
            ...
            <div class="row">
                <div class="col">
                    <h1 class="display-1 text-center">Admin Şifre Değiştirme</h1>
                </div>
            </div>
            <div class="row">
            </div>
    ...
    <main>
       ...
       <form action="" method="post" class="row mt-4 g-3">
            <div class="col-6">
                <label for="ad" class="form-label">Şifresi Değiştirilecek Admin</label>
                <input type="text" class="form-control" name="Admin" required>
            </div>
            <div class="col-6">
                <label for="sad" class="form-label">Yeni Şifre</label>
